...
const String SUBSCRIBE_TOPIC = "rfdevices/station1/dip/+/switch";
const String TOPIC_ROOT = "rfdevices/station1/dip/";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  Serial.printf("Payload: %s\n", strPayload);
    ...
    String pubTopic = TOPIC_ROOT + String(code1) + ":" + String(code2) + TOPIC_STATE;
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      // ... and resubscribe
      // topic + clientID + in
      String subscribeTopic = TOPIC_ROOT + "+" + TOPIC_SWITCH;
